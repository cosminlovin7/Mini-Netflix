...
public class SortByNumberOfRatings implements Comparator<OrderedList> {
    /**
     *Se sorteaza dupa numarul de rating-uri.
     * Daca cele doua elemente din lista, au numarul
     * de rating-uri egale, atunci se sorteaza dupa
     * nume.
     * @param o1
     * @param o2
     * @return
